...
Використовує OpenAI GPT через ai.generate_script_scenes_with_ai. Без ключа або
...
руху камери, GPT сам обирає найбільш підходящий варіант зі списку в
backend/camera_movements.py під дію конкретної сцени) і transition_prompt
(готовий рекомендований промт переходу в наступну сцену, GPT обирає
...
Тривалість відео користувач більше не обирає - GPT сам вирішує,
...
def generate_script(topic: str, language: str = "uk") -> dict:
    ...
    GPT через ai.py сам вирішує природну кількість сцен під ~25-30с
