...
def _build_script_prompt(topic: str, scene_count: int, language: str) -> str:
    ...
    return (
        ...
        "має бути ЛАКОНІЧНИМ (1-2 речення) - лише предмет, місце дії, "
        "ключова дія й освітлення. НЕ додавай зайвих декоративних деталей, "
        "додаткових персонажів чи предметів, яких немає в описі сцени - "
        "кожне зайве слово в промті може з'явитися на картинці як окремий "
        "непотрібний елемент.\n"
