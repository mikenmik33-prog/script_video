...
def _build_script_prompt(topic: str, scene_count: int, language: str) -> str:
    ...
    return (
        ...
        "(сила удару, уламки, потужний рух, руйнування, напруга), а НЕ "
        "виглядати як спокійна, естетично гарна чи мальовнича картинка - "
        "інакше сцена втрачає драматизм тексту. Кожна сцена повинна "
